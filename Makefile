...
update-contracts:
	...
	@echo '// this file is autogenerated from https://contracts.telestoworld.org/addresses.json, do not edit manually' > src/contracts.ts
	@echo 'export = (' >> src/contracts.ts
	@curl -s https://contracts.telestoworld.org/addresses.json >> src/contracts.ts
	...
	@curl \
		...
		-s https://api.thegraph.com/subgraphs/name/telestoworld/collections | jq '.data.collections' >> src/collections-v1.ts
